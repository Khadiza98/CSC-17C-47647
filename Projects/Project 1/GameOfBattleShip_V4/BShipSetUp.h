 ...
 * Created on October 16, 2024, 3:24 PM
...
public:
    ...
    void drawPlayerArea(list<list<char>>); //Display player matrix     
    ...
    bool checkSuccessful(BShipSetUp bShipInfo, int row, int col);// Check where the attack is successful or not
};
